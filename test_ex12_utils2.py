...
def test_find_length_n_words_4board():
    ...
    assert sorted(find_length_n_words(4, B, WORDS1)) == sorted(B4WORDS1)
    assert sorted(find_length_n_words(3, B, WORDS1)) == sorted(B3WORDS1)
    # assert find_length_n_words(1, B, WORDS1) == B1WORDS1
    # assert sorted(find_length_n_words(9, B, WORDS1)) == sorted(B9WORDS1)
